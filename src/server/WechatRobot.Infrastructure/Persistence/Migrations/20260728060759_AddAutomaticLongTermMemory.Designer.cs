...
namespace WechatRobot.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260728060759_AddAutomaticLongTermMemory")]
    partial class AddAutomaticLongTermMemory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WechatRobot.Infrastructure.Persistence.Entities.MemoryCandidateEntity", b =>
                {
                    ...
                    b.HasIndex("ScopeType", "RobotConfigId", "GroupProfileId", "SubjectKey", "MemoryType", "Fingerprint")
                        .IsUnique()
                        .HasDatabaseName("UX_memory_candidate_legacy_scope_fingerprint");
