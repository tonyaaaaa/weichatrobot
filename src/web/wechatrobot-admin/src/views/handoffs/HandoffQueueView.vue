...
import {
  ...
  type HandoffSummary, type HandoffTransition
} from '../../api/handoffs';
...
async function assignCase() {
  ...
  if (!record || !assignee.value) { error.value = '请输入有效的客服用户 ID。'; return; }
    ...
    <section class="split-layout">
      ...
      <aside class="panel detail-panel">
        ...
        <template v-else>
          ...
          <label for="assignee-id">客服用户 ID</label><input id="assignee-id" v-model="assignee" data-testid="assignee">
