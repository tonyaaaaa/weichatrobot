...
export const navigation: NavigationItem[] = [
  ...
  { name: 'private-knowledge-ingests', label: '私聊知识入库', roles: ['Admin'] },
  { name: 'memory-center', label: '记忆中心', roles: ['Admin', 'KnowledgeOperator'] },
  { name: 'fixed-replies', label: '固定回复模板', roles: ['Admin'] },
  ...
  { name: 'agent-diagnostics', label: '智能回复诊断', roles: ['Admin'] },
...
export const routes: RouteRecordRaw[] = [
  { path: '/login', name: 'login', component: LoginView, meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'knowledge/private-ingests', name: 'private-knowledge-ingests', component: () => import('../views/knowledge/PrivateKnowledgeIngestView.vue'), meta: { roles: ['Admin'] } },
      ...
      { path: 'fixed-replies', name: 'fixed-replies', component: () => import('../views/fixed-replies/FixedReplyTemplatesView.vue'), meta: { roles: ['Admin'] } },
      ...
      { path: 'operations/send-commands', name: 'send-queue', component: () => import('../views/operations/SendQueueView.vue'), props: route => ({ initialGroup: route.query.group ?? '' }), meta: { roles: ['Admin'] } },
      { path: 'operations/agent-diagnostics', name: 'agent-diagnostics', component: () => import('../views/operations/AgentDiagnosticsView.vue'), meta: { roles: ['Admin'] } },
