...
describe('role-aware navigation', () => {
  it.each([
    ['Admin', ['工作台', '知识库', '知识库标签', '知识审核', '群管理', '人工转接', '会话审计', '模型配置', '用户与角色', '系统设置'], []],
    ['KnowledgeOperator', ['工作台', '知识库', '知识库标签', '知识审核', '会话审计'], ['群管理', '人工转接', '模型配置', '用户与角色', '系统设置']],
    ['HumanAgent', ['工作台', '人工转接'], ['知识库', '知识库标签', '知识审核', '群管理', '会话审计', '模型配置', '用户与角色', '系统设置']]
